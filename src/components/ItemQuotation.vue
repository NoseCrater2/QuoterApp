<template>
    <!-- " @right="onRight" top-color="yellow"  right-color="orange" draggable="false" -->
    <!-- <q-slide-item style="height: 80px" @left="onLeft" left-color="red" > -->
      <q-item clickable @click="seeDetails(item)" class="bordered bg-white q-ma-sm">
        <q-item-section >
